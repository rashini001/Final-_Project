...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="main dish">Foreign Food</option>
         <option value="fast food">Traditional Food</option>
         <option value="drinks">Sea Food</option>
         <option value="desserts">Soup</option>
